...
CALENDAR_URLS = ['https://data.insideairbnb.com/united-states/ny/new-york-city/2025-09-01/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/united-states/ca/los-angeles/2025-09-01/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/united-states/ca/san-francisco/2025-09-01/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/united-states/il/chicago/2025-09-22/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/united-states/tx/austin/2025-09-16/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/united-kingdom/england/london/2025-09-14/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/france/ile-de-france/paris/2025-09-12/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/spain/catalonia/barcelona/2025-09-14/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/the-netherlands/north-holland/amsterdam/2025-09-11/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/germany/be/berlin/2025-09-23/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/japan/kant%C5%8D/tokyo/2025-09-29/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/australia/nsw/sydney/2025-09-12/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/thailand/central-thailand/bangkok/2025-09-26/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/canada/on/toronto/2025-11-11/data/calendar.csv.gz',
                 'https://data.insideairbnb.com/mexico/df/mexico-city/2025-09-27/data/calendar.csv.gz']

CALENDER_PATH = "./data/calendar"

def download_calendar(store_dir: str, urls: list[str]):
...
if __name__ == "__main__":
    download_files()
    download_reviews()
    download_calendar(CALENDER_PATH, CALENDAR_URLS)
